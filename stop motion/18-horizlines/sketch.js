...
var x =(r.random(0,r.width))
var y = i*8
r.line(x,y,x+r.random(20,40),y)
// .rotate(r.random(0,20),r.width/2,(r.height/2))
.stroke(strokeColor)
.strokeWidth(r.random(0,2));

// r.line(x,r.height/2,x,y)
// .rotate(r.random(0,10),r.width/2,(r.height/2))
// .stroke(0)
